...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_FN1] = LAYOUT(
      ...
      KC_CAPS,  KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______,           _______, KC_GRV , _______, _______,  KC_PGUP,  _______, _______, _______, _______,
      _______,  KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______,           KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,  _______,  _______, _______,          KC_VOLU,
      _______,  _______, _______, _______, _______, _______,           KC_PGDN, KC_PGDN, _______, _______,  KC_INS ,  KC_DEL , _______, _______, KC_VOLD,
      _______,  _______, _______, _______, _______,                    _______, _______,          _______,  _______,  _______, _______, _______, _______),
   [_FN2] = LAYOUT(
      RESET  ,  KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_4, KC_KP_5, KC_KP_F6, KC_KP_6, KC_KP_7, KC_KP_8, KC_KP_9,  KC_KP_0,  KC_PMNS, KC_PEQL,  _______,KC_P1,
      _______,  KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______,           KC_KP_7, KC_KP_8, KC_KP_9, _______,  _______,  _______, _______, _______, KC_P2,
      _______,  KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______,           KC_KP_4, KC_KP_5, KC_KP_6, _______,  _______,  _______, KC_PENT,          KC_MPRV,
      _______,  _______, _______, _______, _______, _______,           KC_KP_0, KC_KP_1, KC_KP_2, KC_KP_3,  _______,  _______, _______, _______, KC_MNXT,
