...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
     ...
     KC_F5   ,MO(_LOWER) ,KC_A    ,KC_S    ,KC_D   ,KC_F   ,KC_G         ,KC_H    ,KC_J   ,KC_K   ,KC_L    ,KC_SCLN   ,KC_QUOT ,KC_ENT  ,KC_ENT  ,KC_PGUP ,
     KC_INS  ,KC_LSFT    ,KC_Z    ,KC_X    ,KC_C   ,KC_V   ,KC_B         ,KC_B    ,KC_N   ,KC_M   ,KC_COMM ,KC_DOT    ,KC_SLSH ,KC_RSFT ,KC_UP   ,KC_PGDN ,
     KC_DEL  ,KC_LCTL    ,KC_LWIN ,KC_LALT ,KC_APP ,KC_SPC ,KC_SPC       ,KC_RALT ,KC_SPC ,KC_SPC ,KC_RALT ,MO(_LOWER),KC_DEL  ,KC_LEFT ,KC_DOWN ,KC_RGHT 
  ),
  [_LOWER] = LAYOUT(
